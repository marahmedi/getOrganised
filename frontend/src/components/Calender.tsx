...
const Calender: React.FC<CalenderProps> = ({ setDay, setStartTime , startTime, endTime, setEndTime}) => {
  const [showDates, setShowDates] = useState(true);
  return (
    <div className="calender-box bg-white w-[25rem] h-[23rem] mt-1 mb-11">
      {showDates ? <Dates  setDay={setDay} /> : <Times setStartTime={setStartTime} setEndTime={setEndTime} startTime={startTime} endTime={endTime} />}
